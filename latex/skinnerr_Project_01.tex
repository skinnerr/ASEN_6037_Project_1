...
\begin{figure}[h!]
\centering
\includegraphics[trim=1cm 0cm 0cm 0cm]{prob1_3_HIT.pdf}
\\
\includegraphics[trim=1cm 0cm 0cm 0cm]{prob1_3_HST.pdf}
\\[6pt]
...
Carrying out this calculation, we obtain the results shown in \figref{fig:prob_1_5_xzaverages}. The isotropic (HIT) case has near-zero $xz$-average velocity in all Cartesian directions for all $y$. The shear (HST) case averages show $u$ varying linearly from $-3$ to $3$ as a function of $y$, whereas the other two components have zero average velocity, independent of $y$. Both observations confirm our expectations from the previous problem regarding homogeneous directions.
...
\begin{figure}[h!]
\centering
\includegraphics[trim=1cm 0cm 0cm 0cm]{prob1_7_HIT.pdf}
\\[6pt]
...
How do the PDFs in the HST case vary between the different values of j? How do the pdfs of
the velocity components compare in the HIT and HST cases? What are the similarities and
differences between the pdfs in the HIT and HST cases? How do the various pdfs compare to
each other and to the Gaussian pdf? What do these results tell us about the statistics of the
velocity in turbulent flows?
...
%\begin{center}
%\\[6pt]
%\caption{Final pdf of $w$.}
%\label{fig:q1_beta_prime}
%\end{center}
%\end{wrapfigure}
