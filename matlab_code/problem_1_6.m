function [] = problem_1_6( HIT, HST, save_plots )
    ...
    % Get xz-averages from problem 1.5 (save_plots for 1.5 is false).
    xzAvgFull = problem_1_5(HIT,HST,false);

    for simulation_case = {'HST'}
        ...
        for dim = 1:3
            ...
            % Subtract off $<u_i>_{xy}(y)$ for each y-coordinate.
            for y = 1:129
                image_data(y,:) = image_data(y,:) - xzAvg(dim,y);
            end
